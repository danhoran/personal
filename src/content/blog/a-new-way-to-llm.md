...
For the average person, one subscription is enough. They will subscribe to a single service which is more than likely to be whatever platform has momentum (or the better marketing team). 9 times out of 10 this will be ChatGPT. This is the simple life. OpenAI has made ChatGPT ubiquitous. It's available on the web, on your desktop, and on your phone. One monthly payment gives you acceess to a decent LLM wherever you need it for a reasonable price.
...
Assuming you, like me, want to use the best tool for job you're in for a bumpy ride. Simultaneous access to ChatGPT, Gemini, and Claude 'premium' subscriptions is going to cost in the region of $60-$100 per month, assuming you're not in need of unlimited plans. These are flat fees with capped usage limits.
...
### 2. Easy access to inexpensive models
